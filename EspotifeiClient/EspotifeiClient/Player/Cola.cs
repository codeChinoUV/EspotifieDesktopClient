...
namespace EspotifeiClient.Player
{
    public class Cola
    {
        ...
        {
            TipoCancionAReproducir tipoCancion = TipoCancionAReproducir.Ninguno;
        ...
        /// </summary>
        /// <param name="anterior">Inidica si la cancion a recuperar es la anterior en la cola de reproduccion o es
        /// la siguiente</param>
        ...
        /// </summary>
        /// <param name="anterior">Inidica si la cancion personal a recuperar es la anterior en la cola de
        /// reproduccion o es la siguiente</param>
        ...
        /// </summary>
        /// <param name="anterior">Inidica si la cancion sin conexion a recuperar es la anterior en la cola de reproduccion o es
        /// la siguiente</param>
